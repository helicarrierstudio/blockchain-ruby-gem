...
def get_block(block_id, api_code = nil)
	params = api_code.nil? ? { } : { 'api_code' => api_code }
	resource = 'rawblock/' + block_id
	response = call_api(resource, method: 'get', data: params)
	return Block.new(JSON.parse(response))
end

def get_tx(tx_id, api_code = nil)
	params = api_code.nil? ? { } : { 'api_code' => api_code }
...
def get_block_height(height, api_code = nil)
	params = { 'format' => 'json' }
...
def get_address(address, api_code = nil)
	params = api_code.nil? ? { } : { 'api_code' => api_code }
...
def get_unspent_outputs(address, api_code = nil)
...
def get_unconfirmed_tx(api_code = nil)
	params = { 'format' => 'json' }
	if !api_code.nil? then params['api_code'] = api_code end
...
def get_blocks(api_code = nil, time: nil, pool_name: nil)
	params = { 'format' => 'json' }
	if !api_code.nil? then params['api_code'] = api_code end
	resource = "blocks/"
	if !time.nil?
...
def get_inventory_data(hash, api_code = nil)
	params = { 'format' => 'json' }
	if !api_code.nil? then params['api_code'] = api_code end
	resource = "inv/#{hash}"
	response = call_api(resource, method: 'get', data: params)
