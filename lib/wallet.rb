...
class Wallet
	...
	def send_many(recipients, from_address: nil, fee: nil, note: nil)
		...
		response = call_api("merchant/#{@identifier}/#{method}", method: 'post', data: params)
	...
	def get_balance()
		response = resp = call_api("merchant/#{@identifier}/balance", method: 'get', data: build_basic_request())
		json_response = parse_json(response)
	...
	def list_addresses(confirmations = 0)
		...
		response = call_api("merchant/#{@identifier}/list", method: 'get', data: params)
		json_response = parse_json(response)
	...
	def get_address(address, confirmations = 0)
		...
		params['confirmations'] = confirmations
		response = call_api("merchant/#{@identifier}/address_balance", method: 'get', data: params)
		json_response = parse_json(response)
	...
	def new_address(label = nil)
		...
		response = call_api("merchant/#{@identifier}/new_address", method: 'post', data: params)
		json_response = parse_json(response)
	...
	def archive_address(address)
		params = build_basic_request()
		params['address'] = address
		response = call_api("merchant/#{@identifier}/archive_address", method: 'post', data: params)
		json_response = parse_json(response)
	...
	def unarchive_address(address)
		params = build_basic_request()
		params['address'] = address
		response = call_api("merchant/#{@identifier}/unarchive_address", method: 'post', data: params)
		json_response = parse_json(response)
	...
	def consolidate(days)
		params = build_basic_request()
		params['days'] = days
		response = call_api("merchant/#{@identifier}/auto_consolidate", method: 'post', data: params)
		json_response = parse_json(response)
